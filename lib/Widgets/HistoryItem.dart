...
class HistoryItem extends StatelessWidget {
  ...
  double get percentTime {
    ...
    double timeLeft = (listItem.endMilisecond - current) /
        (listItem.endMilisecond - listItem.startMilisecond);
  ...
  String get timeLeft {
    ...
    if (minutes > 60)
      return ((listItem.endMilisecond - current) / 3600000).round().toString() +
          "h left";
